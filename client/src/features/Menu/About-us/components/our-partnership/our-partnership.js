      ...
      <div className="row">
        ...
        <div className="col-12">
          <div className="row mt-3">
            {OUR_PARTNERSHIPS.map((partner) => (
              <div className="col-sm-12 col-md-12 col-lg-2 mb-4">
                <div className="d-flex justify-content-center">
...
<div className="icon-img">
                  ...
                  <div className="profile-name">
                    <h3 className="text-center mt-3">John Doe</h3>
                  </div>
                  <div className="information">
                    <p
                      className="text-center"
                    ...
                    >
                      Mr. John Doe is the founder of MyShop. He is a very
                      passionate person who loves to help people.
                    </p>
                  </div>
                    ...
                    <div className="d-flex justify-content-center">
                      <div className="icon">
                        <a
                          ...
                          className="m-1 social-media-link"
                        >
                          <svg
